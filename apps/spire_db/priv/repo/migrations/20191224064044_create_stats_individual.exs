defmodule Spire.SpireDB.Repo.Migrations.CreateStatsIndividual do
  use Ecto.Migration

  def change do
    create table(:stats_individual) do
      add :real, :boolean, null: false, default: false
    ...
    create unique_index(:stats_individual, [:player_id, :class, :real])
  end
end
